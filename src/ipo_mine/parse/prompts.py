"""
Prompts for LLM-based validation of parsed S-1 filing sections.

Two validation prompts are defined:
- VALIDATION_PROMPT: Binary (Yes/No) — does the section appear structurally complete?
- LIKERT_PROMPT: Likert scale (1-5) — confidence in section completeness.
"""
